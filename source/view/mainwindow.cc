...
bool MainWindow::closeSRAM() {
    ...
    if (sram->isModified()) {
        int choice = QMessageBox::question(this,
            tr("Warning: Unsaved Changes"), tr("Save changes?"),
...
void MainWindow::loadSRAMData() {
    ...
    switch (sram->getQuest()) {
        case QUEST_FIRST: ui.radioQuestFirst->setChecked(true); break;
        case QUEST_SECOND: ui.radioQuestSecond->setChecked(true); break;
    }
    
    // load the sword type
    switch (sram->getSword()) {
        case SWORD_NONE: ui.radioSwordNone->setChecked(true); break;
        case SWORD_WOODEN: ui.radioSwordWooden->setChecked(true); break;
        case SWORD_WHITE: ui.radioSwordWhite->setChecked(true); break;
        case SWORD_MASTER: ui.radioSwordMaster->setChecked(true); break;
    }
    
    // load the arrow type
    switch (sram->getArrows()) {
        case ARROW_NONE: ui.radioArrowsNone->setChecked(true); break;
        case ARROW_WOODEN: ui.radioArrowsWooden->setChecked(true); break;
        case ARROW_SILVER: ui.radioArrowsSilver->setChecked(true); break;
    }
    
    // load the candle type
    switch (sram->getCandle()) {
        case CANDLE_NONE: ui.radioCandleNone->setChecked(true); break;
        case CANDLE_BLUE: ui.radioCandleBlue->setChecked(true); break;
        case CANDLE_RED: ui.radioCandleRed->setChecked(true); break;
    }
    
    // load the potion type
    switch (sram->getPotion()) {
        case POTION_NONE: ui.radioPotionNone->setChecked(true); break;
        case POTION_BLUE: ui.radioPotionBlue->setChecked(true); break;
        case POTION_RED: ui.radioPotionRed->setChecked(true); break;
    }
    
    // load the ring type
    switch (sram->getRing()) {
        case RING_NONE: ui.radioRingNone->setChecked(true); break;
        case RING_BLUE: ui.radioRingBlue->setChecked(true); break;
        case RING_RED: ui.radioRingRed->setChecked(true); break;
    }
    ...
    switch (sram->getNote()) {
        case NOTE_OLDMAN: ui.radioNoteOldMan->setChecked(true); break;
        case NOTE_LINK: ui.radioNoteLink->setChecked(true); break;
        case NOTE_OLDWOMAN: ui.radioNoteOldWoman->setChecked(true); break;
    }
...
void MainWindow::updateUI() {
    ...
    if (open) {
        switch (sram->getGame()) {
            case 0: ui.gameGame1->setChecked(true); break;
            case 1: ui.gameGame2->setChecked(true); break;
            case 2: ui.gameGame3->setChecked(true); break;
...
void MainWindow::on_fileOpen_triggered(bool) {
    ...
    QString filename = QFileDialog::getOpenFileName(this,
        tr("Open Legend of Zelda SRAM File"), "", tr("SRAM Files (*.sav)"));
